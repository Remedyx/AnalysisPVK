...
= \underbrace{\sqrt{\big( 1 - \frac{5}{n-3} \big)^{n-3}}}_{\Longrightarrow \sqrt{e^{-5}}=e^{-5/2}} \cdot \underbrace{\sqrt{\big( 1 - \frac{5}{n-3} \big)^{3}}}_{\Longrightarrow \sqrt{1^3}=1} \cdot \sqrt{\big( 1 - \frac{5}{n-3} \big)^{\sqrt{n}}} .$$

\begin{claim}
$$\lim_{n \rightarrow \infty} \big( 1 - \frac{5}{n-3} \big)^{\sqrt{n}}=1.$$
\end{claim}
\begin{proof}
$$ \log\bigg((1- \frac{5}{n-3})^{\sqrt{n}}\bigg) = \frac{\sqrt{n}}{n-3} \log\bigg((1- \frac{5}{n-3})^{n-3}\bigg) \Longrightarrow 0 \cdot \log(e^{-5})=0.$$
Damit erhalten wir
...
$$= n^{1/n} \max_{i\in \{1,\dots, p \}} a_i \longrightarrow \max_{i\in \{1,\dots, p \}} a_i, \quad \text{ f\"ur } n \longrightarrow \infty.$$
...
$$ \lim_{n \longrightarrow \infty} \bigg( \frac{1}{1\cdot 2} + \frac{1}{2\cdot 3} + \frac{1}{3 \cdot 4} + \dots + \frac{1}{(n-1)\cdot n} \bigg).$$
\end{ex}
\begin{solution}
Wir berechnen
...
\begin{align*}
\lim_{n \rightarrow \infty} \frac{a_n}{b_n} = \lim_{n \rightarrow \infty} \frac{\frac{2n^2 + 2n +3}{6n^5 + 6}}{\frac{1}{n^3}} = \lim_{ n \rightarrow \infty} \frac{n^3(2n^2+2n+3)}{6n^5+6}= \lim_{n \rightarrow \infty} \frac{2n^5}{6n^5}= \frac{1}{3} \in (0, \infty)
\end{align*}
...
\end{ex}
\begin{solution}
Wir definieren $a:=\inf_{x\in \RR} f(x)$ und $b:=\sup_{x\in \RR} f(x)$. Dann gilt $Im(f) \subseteq [a,b]$ und wir k\"onnen $f$ einschr\"anken auf $f:[a,b] \longrightarrow [a,b]$. Da $f$ stetig ist, folgt die Behauptung dem Fixpunktsatz.
\end{solution}
...
\end{ex}
\begin{solution}
Sei $(x_n)_{n \in \NN}\subseteq (0,1]$ mit $x_n \longrightarrow 0$. Dann ist $(x_n)_{n \in \NN}$ eine Cauchyfolge (da sie konvergiert). Da $f$ gleichm\"assig stetig ist, ist $(f(x_n))_{n\in \NN}$ ebenfalls eine Cauchyfolge (Aufgabe 24). Da $\RR$ vollst\"andig ist (Satz 3.23), existiert ein $c\in \RR$, sodass $f(x_n) \longrightarrow c$. Sei nun $(y_n)_{n\in \NN}\subseteq (0,1]$, sodass $y_n \longrightarrow 0$. Wir definieren f\"ur $n\in \NN$
...
$$0 \leq e^5  \bigg(\frac{e}{x}\bigg)^{x-5} \leq \bigg(\frac{1}{2}\bigg)^{x-5} \longrightarrow 0,
...
\begin{enumerate}[i)]
\item \begin{align*}
0 \longleftarrow -x^2 \leq x^2 \sin \left( \frac{1}{x} \right) \leq x^2 \longrightarrow 0, \text{ als } x \longrightarrow 0 
\end{align*}
da $x^2 \geq 0$.
\item Wir haben $-1 \leq \cos (x) \leq 1$ und somit $ 1 \geq - \cos(x) \geq -1 $ also
\begin{align*}
0 \longleftarrow \frac{1}{x+3} \leq \frac{2- \cos x}{x+3} \leq \frac{3}{x + 3} \longrightarrow 0  \text{ als } x \longrightarrow \infty 
\end{align*}
...
\begin{align*}
0 \longleftarrow x^2 e^{-1} \leq x^2 \exp \left(  \sin^3 \left( \frac{1}{x} \right) \right) \leq x^2 e^1 \longrightarrow 0, \text{ als } x \longrightarrow 0 
\end{align*}
\end{enumerate}
\end{solution}
...
\begin{align*}
\frac{5x-2}{x^2-3x+2} \frac{x^2+1}{x-3} =\frac{5x^3-2x^2+5x-2}{x^3-6x^2+12x-6} \longrightarrow 5 \text{ als } x \longrightarrow \infty 
\end{align*}
...
\leq \frac{2 \cdot \log(16)}{ n} \longrightarrow 0, \quad \text{ f\"ur } n \longrightarrow \infty.$$
\item
Nein.
...
$"\Longleftarrow"$ Sei nun $f'(x)=g'(x)$ f\"ur ein fixes $x\in (a,b)$. Sei $\epsilon>0$.
...
\item Seien $f,g : [a,b] \longrightarrow \mathbb{R}$ sodass $f \leq g$. Dann gilt: $\displaystyle \int_a^b f(x)~dx \leq \int_a^b f(x) ~dx$.
