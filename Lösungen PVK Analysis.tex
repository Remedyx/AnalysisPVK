...
\end{solution}
\begin{ex}{$(\star)$}
Entscheiden Sie f\"ur jede Aussage, ob sie wahr ist oder falsch.
\begin{enumerate}[a.)]
\item
Sei $(z_n)_{n\in \NN} \subseteq \CC$, $z\in \CC$.
...
\item
Sei $A\subseteq \RR$ und $\emptyset\neq A$. Sei $-A=\{ x\in \RR \vert -x\in A  \}$.
