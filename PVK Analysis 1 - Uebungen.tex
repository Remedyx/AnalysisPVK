...
\begin{solution} Per Definition ist die Exponentialfunktion gegeben als 
\begin{align*}
...
\end{align*}
\item Die Dreiecksungleichung ist der schwierigste Teil. Da $d$ eine Metrik auf $X$ ist folgt $d(x,z) \leq d(x,y)+d(y,z)$. Also gilt auch
\begin{align*}
